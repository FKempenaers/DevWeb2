...
/**
 * Classe qui permet d'enregistrer un fichier sur le serveur
 */
public class GestionFichiers {

	public static boolean ajouterFichier(String pseudo, String description, Part filePart, String fileName)
			throws IOException {
		int ajout_fichier = -1;
